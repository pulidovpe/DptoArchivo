...
<div id="divpadre4">	
			         ...
			         header("Content-Type: text/html;charset=utf-8");
						...
						if($cant>0){						
							while($rs = mysql_fetch_array($res)){
								$valor = $rs['descripTExp'];
								$valor1 = $rs['codTipoExp'];
					?>				
				<option value="<?php echo $valor1; ?>">
					<?php echo $valor; 
					    }
				   }
					?>
	...
	<tr>
		...
		<input type="button" name="buscar" id="buscar" value="Buscar" onclick="javascript:buscarDato('6'); return false" />

...
$query = "SELECT * FROM especialidad ORDER BY codEsp ASC";
...
$titles = array(
				'codEsp'=>'<b>Código</b>',
				'descripEsp'=>'<b>Descripción de la Especialidad</b>',
				'nivelAca'=>'<b>Nivel Académico</b>'
			);
$options = array(
...
$txttit.= "Reporte de Especialidades archivados a la fecha. \n";
